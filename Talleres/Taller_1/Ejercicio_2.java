...
public class Ejercicio_2 extends JFrame {  // Cambié el nombre de la clase a Ejercicio_1
    JLabel etiNombre, etiCiudad;
    JButton btnOcultarNombre, btnVisuNombre, btnOcultarCiudad, btnVisuCiudad;

    public Ejercicio_2() {  // Cambié el nombre del constructor a Ejercicio_1
        setLayout(null);
    ...
    public static void main(String[] args) {
        new Ejercicio_2().setVisible(true);  // Cambié el nombre de la clase en la llamada
    }
}
